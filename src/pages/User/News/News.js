                    ...
                    <div className={cx('row')}>
                        ...
                        <div className={cx('col-lg-4', 'col-md-6', 'col-sm-6')}>
                            <div className={cx('blog__item')}>
                                ...
                                <div className={cx('blog__item__text')}>
                                    <span>
                                        <img src={'http://localhost:8080/img/icon/calendar.png'} alt="" /> 21 February
                                        2020
                                    </span>
                        ...
                        <div className={cx('col-lg-4', 'col-md-6', 'col-sm-6')}>
                            <div className={cx('blog__item')}>
                                ...
                                <div className={cx('blog__item__text')}>
                                    <span>
                                        <img src={'http://localhost:8080/img/icon/calendar.png'} alt="" /> 28 February
                                        2020
                                    </span>
                        ...
                        <div className={cx('col-lg-4', 'col-md-6', 'col-sm-6')}>
                            <div className={cx('blog__item')}>
                                <div className={cx('blog__item__pic', 'set-bg')} data-setbg="img/blog/blog-4.jpg">
                                    <img src={'http://localhost:8080/img/blog/blog-4.jpg'} alt="" />
                                </div>
                                <div className={cx('blog__item__text')}>
                                    <span>
                                        <img src={'http://localhost:8080/img/icon/calendar.png'} alt="" /> 16 February
                                        2020
                                    </span>
                                    <h5>Hướng đến mục tiêu cao hơn của Mastopexy</h5>
                                    <Link to="#">Đọc Thêm</Link>
                        ...
                        <div className={cx('col-lg-4', 'col-md-6', 'col-sm-6')}>
                            <div className={cx('blog__item')}>
                                <div className={cx('blog__item__pic', 'set-bg')} data-setbg="img/blog/blog-5.jpg">
                                    <img src={'http://localhost:8080/img/blog/blog-5.jpg'} alt="" />
                                </div>
                                <div className={cx('blog__item__text')}>
                                    <span>
                                        <img src={'http://localhost:8080/img/icon/calendar.png'} alt="" /> 21 February
                        ...
                        <div className={cx('col-lg-4', 'col-md-6', 'col-sm-6')}>
                            <div className={cx('blog__item')}>
                                ...
                                >
                                    <img src={'http://localhost:8080/img/blog/blog-6.jpg'} alt="" />
                                </div>
                                <div className={cx('blog__item__text')}>
                                    <span>
                                        <img src={'http://localhost:8080/img/icon/calendar.png'} alt="" /> 28 February
                        ...
                        <div className={cx('col-lg-4', 'col-md-6', 'col-sm-6')}>
                            <div className={cx('blog__item')}>
                                <div className={cx('blog__item__pic', 'set-bg')} data-setbg="img/blog/blog-7.jpg">
                                    <img src={'http://localhost:8080/img/blog/blog-7.jpg'} alt="" />
                                </div>
                                <div className={cx('blog__item__text')}>
                                    <span>
                                        <img src={'http://localhost:8080/img/icon/calendar.png'} alt="" /> 16 February
                        ...
                        <div className={cx('col-lg-4', 'col-md-6', 'col-sm-6')}>
                            <div className={cx('blog__item')}>
                                <div className={cx('blog__item__pic', 'set-bg')} data-setbg="img/blog/blog-8.jpg">
                                    <img src={'http://localhost:8080/img/blog/blog-8.jpg'} alt="" />
                                </div>
                                <div className={cx('blog__item__text')}>
                                    <span>
                                        <img src={'http://localhost:8080/img/icon/calendar.png'} alt="" /> 21 February
                        ...
                        <div className={cx('col-lg-4', 'col-md-6', 'col-sm-6')}>
                            <div className={cx('blog__item')}>
                                <div className={cx('blog__item__pic', 'set-bg')} data-setbg="img/blog/blog-9.jpg">
                                    <img src={'http://localhost:8080/img/blog/blog-9.jpg'} alt="" />
                                </div>
                                <div className={cx('blog__item__text')}>
                                    <span>
                                        <img src={'http://localhost:8080/img/icon/calendar.png'} alt="" /> 28 February
